  ...
  return (
    <>
      {!data ? (
        ...
        <section className="py-32 bgimg max-width">
          ...
          <div className="max-width grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 px-5 ">
            {data.map(
              ({
                ...
                <article key={id} className="bg-stone-900 p-5 text-white rounded-2xl border-2 border-emerald-500	">
                  ...
                  <p className="mb-3 opacity-75" > mass_kg: {}</p>
                </article>
              )
            )}
          </div>
